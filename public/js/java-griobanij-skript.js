...
/* dla video lazzy ! /*! jQuery & Zepto Lazy - AV Plugin v1.4 - http://jquery.eisbehr.de/lazy - MIT&GPL-2.0 license - Copyright 2012-2017 Daniel 'Eisbehr' Kern */
!function (t) {
...
$(document).ready(function () {
    ...
    $("#send").click(function () {
        ...
        return $.ajax({
            ...
            cache: !1,
            success: function (o) {
                var r = "<p style='font-family:Verdana; font-size:11px; color:green; border:1px solid #00CC00; padding:10px; margin:20px; border-radius:5px; -moz-border-radius:5px; -webkit-border-radius:5px; background-color:#fff;'>Спасибо, <strong>",
                    e = "!</strong> Ваше сообщение отправлено! Мы постараемся сегодня выслать Вам на почту коммерческое предложение со стоимостью создания сайта.</p>",
                    s = r + a + e;
                1 == o ? ($("#loadBar").html(s).fadeIn(3e3), $("#posName").val(""), $("#posPhone").val(""), $("#posMail").val(""), $("#posSite").val(""), $("#posTip").val(""), $("#posStil").val(""), $("#posLogo62").val(""), $("#posKonkurent").val(""), $("#posNravitsia").val(""), $("#posFunk1").val(""), $("#posFunk2").val(""), $("#posFunk3").val(""), $("#posSeoslova").val(""), $("#posSeo72").val(""), $("#posBudget").val(""), $("#posPogelania").val("")) : $("#loadBar").html(o).fadeIn(3e3)
            }
        }), !1
    });
