...
@section('content')
    ...
    <section>
        ...
        <section>
            ...
            @foreach ($material  as $materials) {!!  $materials->body !!} @endforeach


            <div class="container-fluid px-0">
                <div class="container my-5 py5">
                    @foreach ($material as $materials)<p> {{$materials->modul1}} </p><p> {{$materials->mudul2}} {!! setting('site.title') !!}</p>
                        {!!$materials->modul3 !!}
                    @endforeach
            ...
            <div class="container-fluid px-0" id="counter">
                <div class="jumbotron-foto pt-4 pb-4"
                     style="background-color: rgba(98, 98, 98, 0.15); height: 400px">
                    <img class="lazyy fonimg" data-src="../images/fon-aktsia.jpg" alt="study in Ukranr background">
                    <div class="container">
                        <div class="zagolovokform"
                             style="background-color: rgba(255, 255, 255, 0.6196078431372549);">
                            <div class="h1block">
